# This is a MySQL Workbench plugin to generate data dictionaries.
#
# Chakib Ljazouli. All rights waived.
# Say hi if you want to: https://www.linkedin.com/in/ljazouli/
...
<head>
  <meta charset="UTF-8">
  <meta name="author" content="ChakibL">
...
ModuleInfo = DefineModule(name="ChakibDataDico",
                          author="cljazouli",
                          version="1.0.0")
@ModuleInfo.plugin("my.plugin.create_datadict",
                   caption="Generate Data Dictionary in HTML file",
